...
const GameBoy = ({showPokemon,capturePokemon}) => {
  return (
    <div>
        ...
        <div className="body">
          ...
          <div className="button-box">
            ...
            <div className="ab-button a">
              <span className="button-text-height" onClick={()=> capturePokemon()}>A</span>
            </div>

            <div className="ab-button b">
              <span className="button-text-height" onClick={()=> showPokemon()}>B</span>
            </div>
          </div>
